...
CREATE TABLE `amenidad` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `Id_AmenidadPropiedad_FK` FOREIGN KEY (`id`) REFERENCES `propiedad` (`id`)
...
CREATE TABLE `citas` (
  ...
  KEY `Id_EncargadoCita_FK_idx` (`idEncargado`),
...
CREATE TABLE `foto` (
  ...
  PRIMARY KEY (`id`),
  KEY `Id_fotosPropiedad_idx` (`idPropiedad`),
  CONSTRAINT `Id_fotosPropiedad` FOREIGN KEY (`idPropiedad`) REFERENCES `propiedad` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `metodosventa` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `Id_MetodosVentaPropiedad_FK` FOREIGN KEY (`id`) REFERENCES `propiedad` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mueble` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `Id_MueblesPropiedad_FK` FOREIGN KEY (`id`) REFERENCES `propiedad` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (1,'Dan','Gallardo',NULL,'gallardoholdings644@gmail.com','$2y$10$G4b9eO.h8wK14uhc9Id4WuFELxbSF7AZ82po2I56QiZW627uUotFC','5555555555','1',1,NULL,0);
...
CREATE TABLE `venta` (
  ...
  PRIMARY KEY (`id`),
  KEY `Id_VentaPropiedad_FK_idx` (`idPropiedad`),
  KEY `Id_UsuarioVenta_FK_idx` (`idEncargado`),
  CONSTRAINT `Id_UsuarioVenta_FK` FOREIGN KEY (`idEncargado`) REFERENCES `usuario` (`id`),
  CONSTRAINT `Id_VentaPropiedad_FK` FOREIGN KEY (`idPropiedad`) REFERENCES `propiedad` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-05-07 14:10:57
