<main>
    ...
    <section class="carrousel contenedor">
        <div class="carrousel-contenedor contenedor-carrousel-admin">
            <button aria-label="Anterior" class="carrousel__anterior" id="anterior-admin">
                <img src="/build/img/flecha-izquierda.png" alt="">
            </button>
            <div class="carrousel-items" id="C-admin">
            ...
            <button aria-label="Siguiente" class="carrousel__siguiente" id="siguiente-admin">
                <img src="/build/img/flecha-correcta.png" alt="">
            </button>
            <div class="carrousel-indicadores" role="tablist" id="indicadores-admin"></div>
        </div>
    </section>
