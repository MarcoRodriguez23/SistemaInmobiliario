...
<div class="plantilla">
    <a href="/admin/propiedades/info?id=<?php echo $propiedad->idPropiedad; ?>">
        <div class="inmueble">
            ...
            <div class="info-inmueble">
                ...
                <p class="pago"></p>
                <p class="estado"><?php echo $propiedad->idPropiedad;?></p>
    ...
    <div class="opciones">
        <a href="/admin/propiedades/update?id=<?php echo $propiedad->idPropiedad; ?>" class="boton boton-amarillo">Actualizar</a>
        <a href="/admin/propiedades/sell?id=<?php echo $propiedad->idPropiedad; ?>" class="boton boton-verde">Vender</a>
        <a href="/admin/propiedades/date?id=<?php echo $propiedad->idPropiedad; ?>" class="boton boton-azul">Agendar</a>
